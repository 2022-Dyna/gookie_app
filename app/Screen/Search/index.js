...
export default function ScreenA({navigation}) {
  ...
  const getList = () => {
    axios.get('http://144.24.94.124:8091/api/v1/gookie/list', {}).then(res => {
  ...
  return (
    <View style={{height: '100%'}}>
      <ScrollView contentContainerStyle={{paddingBottom: 143, height: '100%'}}>
        <View>
          <Text style={styles.searchTit}>의원찾기</Text>
        </View>
              ...
              <View style={commonStyles.inner}>
                <View
                  ...
                  <TouchableOpacity
                    ...
                    style={{flex: 1}}>
                    <View
                      style={tab === 0 ? styles.tabView : styles.tabViewOff}>
                      <Text
                        style={tab === 0 ? styles.tabText : styles.tabTextOff}>
                        이름순
                      </Text>
                    </View>
                  </TouchableOpacity>
                  <TouchableOpacity
                    ...
                    style={{flex: 1}}>
                    <View
                      style={tab === 1 ? styles.tabView : styles.tabViewOff}>
                      <Text
                        style={tab === 1 ? styles.tabText : styles.tabTextOff}>
                        정당순
                      </Text>
                    </View>
                  </TouchableOpacity>
                  <TouchableOpacity
                    ...
                    style={{flex: 1}}>
                    <View
                      style={tab === 2 ? styles.tabView : styles.tabViewOff}>
                      <Text
                        style={tab === 2 ? styles.tabText : styles.tabTextOff}>
                        지역구순
                      </Text>
                    </View>
                  </TouchableOpacity>
                                ...
                                <TouchableOpacity
                                  ...
                                  <View
                                    ...
                                    <View
                                      ...
                                      <Text style={styles.congressName}>
                                        {conItem.item.name}
                                      </Text>
                                      <Text style={styles.congressParty}>
                                        {conItem.item.group}
                                      </Text>
                                    </View>
                                    <View>
