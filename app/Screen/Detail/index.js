...
export default function Detail({navigation}) {
  ...
  const getDetail = async () => {
    await axios
      .get('http://144.24.94.124:8091/api/v1/gookie/detail', {
        params: {
          monaCd: '0VU8517t',
            ...
            <ImageBackground source={party[partyNum].src} resizeMode="cover">
              <View
                ...
                <View
                  ...
                  <Text style={styles.markText}>2039</Text>
                  <TouchableOpacity
                    activeOpacity={1}
                    onPress={() => {
                      if (loginState.login) {
                  ...
                  <View style={{flex: 1, marginRight: 24}}>
                    ...
                    <View>
                      <Text style={styles.historyTextSubText}>{`${
                        detailProfie != null ? detailProfie.bthDate : 'a'
                      }`}</Text>
                    </View>
                  </View>
                  <View style={{flex: 1}}>
